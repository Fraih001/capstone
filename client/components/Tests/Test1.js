...
export const Editor = (props) => {
  ...
  // const solution = prompts[0]?.narrative;
  ...
  // const getReadOnlyRanges3 = (editor3) => {
  //   return [
  //     {
  //       from: undefined,
  //       to: editor3.doc.line(0).to,
  //     },
  //     {
  //       from: editor3.doc.line(1).from,
  //       to: editor3.doc.line(100).to,
  //     },
  //     {
  //       from: editor3.doc.line(editor3.doc.lines).from,
  //       to: undefined,
  //     },
  //   ];
  // };
  ...
  //       javascript(),
  //       EditorView.lineWrapping,
  //       readOnlyRangesExtension(getReadOnlyRanges3),
  //     ],
  //   });

  //   const view3 = new EditorView({
  //     state,
  //     parent: editor3.current,
  //     lineWrapping: true,
  //   });
  //   return () => {
  //     view3.destroy();
  ...
  return (
    <>
      <Modal
        ...
        <ModalHeader>
          <ModalTitle>Solution Code</ModalTitle>
        </ModalHeader>
        <ModalBody>
          <div>{prompts[0]?.solution}</div>
          {/* <div
